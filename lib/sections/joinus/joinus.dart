...
import 'package:folio/sections/joinus/joinusDesktop.dart';
import 'package:folio/sections/joinus/joinusMobile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ScreenTypeLayout(
          mobile: JoinUsMobileTab(),
          tablet: JoinUsMobileTab(),
          desktop: JoinUsDesktop(),
        ));
  }
}
