...
class GallaryDesktop extends StatefulWidget {
  @override
  State<GallaryDesktop> createState() => _GallaryDesktopState();
}

class _GallaryDesktopState extends State<GallaryDesktop> {
